<?php 
// ===================================================================
// PayPal API - Assinaturas
// ===================================================================
class PayPal_modelMODEL {
	...
	private function contaPagSeguro() {
		$paypal = $this->system->configuracoesgerais->getPayPal();
		$pagSeguro = $this->system->configuracoesgerais->getPagseguro();
		
		$dados['usuario'] = $pagSeguro['paypal_usuario'];
		$dados['assinatura'] = $pagSeguro['paypal_assinatura'];
		$dados['senha'] = $pagSeguro['paypal_senha'];
