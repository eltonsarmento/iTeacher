...
class Quiz extends QuizGlobal {
	...
	protected function doListarCursos() {
		...
		$this->system->admin->topo('quizzes');
		$this->system->view->display('instituicao-professor/cursos_quizzes.tpl');
	...
	private function checarAcesso($cursoId, $professorId) {
		...
		if (!$curso['id']) $this->system->func->redirecionar('/quiz/listarCursos');
	}
	// ==============================================================
