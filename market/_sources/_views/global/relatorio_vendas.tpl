                                                        ...
                                                        <table class="table table-striped table-advance table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>R$ {$venda.valor_liquido|number_format:2}</td>
                                                                    <td class="hidden-xs">
                                                                        
                                                                        <a data-toggle="modal" onclick="getVendasByAluno({$venda.cliente.id});" href="#visualizarHistorico" class="btn btn-success btn-xs tooltips" data-original-title="Histórico" data-placement="bottom"><i class="fa fa-folder"></i></a>
