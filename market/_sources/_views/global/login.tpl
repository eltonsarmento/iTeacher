...
<head>
  ...
  <link rel="shortcut icon" href="{$url_site}common/market/img/favicon.png">
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 tooltipss and media queries -->
    <!--[if lt IE 9]>
      <script src="{$url_site}market/common/js/html5shiv.js"></script>
      <script src="{$url_site}market/common/js/respond.min.js"></script>
      <![endif]-->
  ...
  <body class="login-body">
      ...
      <section class="container">
        ...
        <form class="form-signin" method="post" action="{$form_action}">
          ...
          <h2 class="form-signin-heading"><img src="{$url_site}market/common/market/img/logo-iteacher.png" style="width: 200px;"></h2>
