        ...
        <section id="main-content">
            ...
            <section class="wrapper site-min-height">
                ...
                <section class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Gerenciar Vendas</li>
                ...
                <section class="row">
                    {if $categoria eq 'instituicao-professor'}
                    {else}
                    <section class="col-lg-8">
                        
                        <a href="{$admin_url}/vendas/nova" class="btn btn-success"><i class="fa fa-plus-circle"></i> Adicionar nova</a>
                        
                        <a href="{$admin_url}/vendas/listarTodas" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Todas as vendas</a>
                ...
                <section class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <section class="panel">
                            ...
                            <header class="panel-heading"><strong>Vendas - {$smarty.now|date_format:"%m/%Y"}</strong></header>
            ...
            <section class="modal-dialog">
                ...
                <section class="modal-content">
                    ...
                    <section class="modal-footer">
                        ...
                        <button data-dismiss="modal" class="btn btn-default" type="button">Fechar1</button>
