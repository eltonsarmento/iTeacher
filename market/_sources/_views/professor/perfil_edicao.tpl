                    ...
                    <aside class="profile-nav col-lg-3">
                        ...
                        <section class="panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{$admin_url}/perfil/visualizarContas"> <i class="fa fa-money"></i> Contas Bancárias</a></li>
                                ...
                                <form class="form-horizontal" role="form" method="post">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="dominio" type="text" value="{$professor.dominio}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="email" type="email" value="{$professor.email}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cpf" data-mask="999.999.999-99" value="{$professor.cpf}" type="text">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cep" data-mask="99999-999" value="{$professor.cep}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="bairro" type="text" value="{$professor.bairro}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="telefone" data-mask="(99) 9999 - 9999" value="{$professor.telefone}" type="text">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <textarea class="form-control" name="minicurriculo" cols="30" rows="6">{$professor.minicurriculo}</textarea>
                                ...
                                <form class="form-horizontal" role="form" method="post">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="facebook" type="text" value="{$professor.facebook}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="twitter" type="text" value="{$professor.twitter}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="instagram" type="text" value="{$professor.instagram}" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="youtube" type="text" value="{$professor.youtube}" required>
