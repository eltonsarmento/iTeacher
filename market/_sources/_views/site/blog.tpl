            ...
            <div class="col-lg-9 ">
                <div class="blog-item">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            <div class="blog-img">
                                <img src="{$url_site}market/common/site/img/blog/img1.jpg" alt=""/>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            ...
                            <a href="blog_detail.html" class="btn btn-danger">Continue Lendo</a>
                        </div>
                    </div>
                </div>
                <div class="blog-item">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            <div class="blog-img">
                                <img src="{$url_site}market/common/site/img/blog/img2.jpg" alt=""/>
                            </div>
                ...
                <div class="blog-item">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            <div class="blog-img">
                                <img src="{$url_site}market/common/site/img/blog/img3.jpg" alt=""/>
                            </div>
                ...
                <div class="blog-item">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-sm-10">
                            <div class="blog-img">
                                <img src="{$url_site}market/common/site/img/blog/img4.jpg" alt=""/>
                            </div>
                    ...
                    <div class="blog-post">
                        ...
                        <div class="media">
                            <a class="pull-left" href="javascript:;">
                                <img class=" " src="{$url_site}market/common/site/img/blog/blog-thumb-1.jpg" alt="">
                            </a>
                        ...
                        <div class="media">
                            <a class="pull-left" href="javascript:;">
                                <img class=" " src="{$url_site}market/common/site/img/blog/blog-thumb-2.jpg" alt="">
                            </a>
                            <div class="media-body">
                                <h5 class="media-heading"><a href="javascript:;">02 May 2013 </a></h5>
                                <p>
                        ...
                        <div class="media">
                            <a class="pull-left" href="javascript:;">
                                <img class=" " src="{$url_site}market/common/site/img/blog/blog-thumb-3.jpg" alt="">
                            </a>
                            <div class="media-body">
                                <h5 class="media-heading"><a href="javascript:;">02 May 2013 </a></h5>
                                <p>
