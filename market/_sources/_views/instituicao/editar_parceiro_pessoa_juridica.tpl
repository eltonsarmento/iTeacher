                ...
                <section class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Editar Parceiro - Cursos IAG</li>
                        ...
                        <section class="panel">
                            ...
                            <section class="panel-body">
                                ...
                                <form class="form-horizontal tasi-form" action="" method="post">
                                    <input name="editarPJ" type="hidden" value="1">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <p class="form-control-static"><strong>Pessoa Jurídica</strong></p>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="nome_responsavel" value="{$parceiro.nome_responsavel}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="email_responsavel" value="{$parceiro.email_secundario}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cnpj" data-mask="99.999.999/9999-99" value="{$parceiro.cnpj}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cep" data-mask="99999-999" type="text" value="{$parceiro.cep}" required>
