                ...
                <section class="row">
                    ...
                    <section class="col-lg-4">
                        ...
                        <section class="panel">
                            ...
                            <header class="panel-heading"><strong>Parceiro</strong></header>
                            
                            <section class="list-group">
                                
                                <a class="list-group-item" data-toggle="modal" href="#modeloEmail" onclick="buscarValores(85, 86);">Sua conta for criada</a>
                                <a class="list-group-item" data-toggle="modal" href="#modeloEmail" onclick="buscarValores(87, 88);">Quando fecharmos o relatório do mês</a>
                                <a class="list-group-item" data-toggle="modal" href="#modeloEmail" onclick="buscarValores(89, 90);">Quando uma notificação for deixada</a>
                    ...
                    <section class="col-lg-4">
                        ...
                        <section class="panel">
                            ...
                            <header class="panel-heading"><strong>Coordenador</strong></header>
                            
                            <section class="list-group">
                                
                                <a class="list-group-item" data-toggle="modal" href="#modeloEmail" onclick="buscarValores(91, 92);">Sua conta for criada</a>
                                <a class="list-group-item" data-toggle="modal" href="#modeloEmail" onclick="buscarValores(93, 94);">Quando uma notificação for deixada</a>                                
                                ...
                                <h4><strong>Lista de Shortcode:</strong> </h4>
                                    ...
                                    <table class="table table-striped" width="400px">                                    
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>[[nome_coordenador]]</td><td>[[email_coordenador]]</td><td>[[nome_coordenador]]</td><td>[[senha_usuario]]</td>
                                            </tr>
                                            <tr>
                                                <td>[[nome_parceiro]]</td><td>[[email_parceiro]]</td><td>[[senha_parceiro]]</td><td>[[titulo_notificacao]]</td>
                                            </tr>
                                            <tr>
