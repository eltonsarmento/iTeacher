                ...
                <section class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a href="{$admin_url}/administrador/listar">administrador</a></li>
                ...
                <section class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <section class="panel">
                            ...
                            <header class="panel-heading"><strong>Adicionar Novo - administrador</strong></header>
                                ...
                                <form class="form-horizontal tasi-form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="nome" type="text" id="nome" value="{$administrador.nome}" autofocus required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="email" id="email" value="{$administrador.email}" type="email" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cpf" id="cpf" value="{$administrador.cpf}" data-mask="999.999.999-99" type="text">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="cep" id="cep" value="{$administrador.cep}" data-mask="99999-999" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="endereco" id="endereco" value="{$administrador.endereco}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="complemento" id="complemento" value="{$administrador.complemento}" type="text">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="bairro" id="bairro" value="{$administrador.bairro}" type="text" required>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="telefone" id="telefone" value="{$administrador.telefone}" data-mask="(99) 9999 - 9999" type="text">
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="senha" type="password" {if !$administrador.id} required {/if}>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-10">
                                            ...
                                            <input class="form-control" name="senha2" type="password" {if !$administrador.id} required {/if}>
                                    ...
                                    <section class="form-group">
                                        ...
                                        <section class="col-lg-offset-2 col-lg-10">
                                            ...
                                            <button class="btn btn-success" type="submit"><i class="fa fa-check-circle"></i> {if $administrador.id}Editar{else}Salvar{/if}</button>
                                            <button class="btn btn-default" onclick="$('#nova').val(1)" type="submit"><i class="fa fa-plus-circle"></i> {if $administrador.id}Editar{else}Salvar{/if} e adicionar outro</button>
                                            <span>ou <a href="{$admin_url}/administrador/listar">voltar a listagem</a></span>
