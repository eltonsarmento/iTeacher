                                ...
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="visualizar-professor.html">Adriano Gianini</a></td>
                                            <td>adriano@cursosiag.com.br</td>
                                            <td class="hidden-xs">00000-000</td>
                                            <td class="hidden-xs">000.000.000-00</td>
                                            <td class="hidden-xs">(00) 0000 - 000</td>
                                            <td>
                                                
                                                <a href="visualizar-professor.html" class="btn btn-success btn-xs tooltips" data-original-title="Visualizar" data-placement="bottom"><i class="fa fa-search"></i></a>
