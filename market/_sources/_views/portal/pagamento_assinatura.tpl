		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<form  method="POST" action="{$url_portal}portal/carrinho/assinar/">
...
function pagarPagSeguro() {
	$.post('{/literal}{$url_portal}{literal}portal/carrinho/assinarPagSeguro/', function html(html) { $('#retornoPagamento').html(html)});
}
