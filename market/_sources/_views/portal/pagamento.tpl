			...
			<div class="col-lg-12">
			    ...
			    <div class="row">
                    ...
                    <div class="col-lg-4">
                         ...
                         <form  method="POST" action="{$url_portal}carrinho/concluirPagarme/" >
                            ...
                            {literal}
                                <script type="text/javascript"
                                    ...
                                    data-encryption-key="ek_test_hjju4i8qJQm9hgSnbc1xQsTcTj1s6t"
                                    data-customer-data="false"
                                    data-max-installments="12"
                                    data-button-class="btn btn-white btn-block btn-round btn-lg"
...
<script type="text/javascript" src="{$url_site}lms/common/assets/analytics.js"></script>
<div id="popUp">
