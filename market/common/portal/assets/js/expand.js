...
$.fn.expandAll = function(options) {
    ...
    return this.each(function(index) {
       ...
       (o.switchPosition == 'before') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        (o.oneSwitch) ? ($referent.insrt('<span class="switch"><a href="#" class="' + toggleClass + '">' + toggleTxt + '</a></span>')) :
          ($referent.insrt('<span class="switch"><a href="#" class="">' + o.expTxt+ '</a> <a href="#" class="open">' + o.cllpsTxt+ '</a></span>'));

        // --- var $sw, $cllps, $tr :
        $sw = $referent.findSibling('span').find('a');
        ...
        $sw.click(function() {
            ...
            if (o.parent) {
              var $swChildren = $switch.parent().nextAll().children('span.switch').find('a');
